...
namespace calculator
{
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            firstColumn.Width = new GridLength(7, GridUnitType.Star);
    ...
    public class FormLog
    {
        ...
        */
        ...
        internal void GetButtonList() //Button[] GetButtonList()
        {
            /*
            Button[] button = new Button[16];
            UIElement[] button1 = new UIElement[16];
            window.NumberPanel.Children.CopyTo(button1, 0);
            return button;
            */
        }
